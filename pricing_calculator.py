...
original_piece_min, original_piece_max = st.sidebar.slider("Price of Original Piece ($)", min_value=00.0, max_value=500.0, value=(100.0, 200.0), step=10.0)
labour_hours = st.sidebar.number_input("Labour Hours (Including Sourcing)", min_value=0.0, value=3.0, step=0.5)
labour_cost = labour_hours * 80  # Fixed hourly rate at $80
profit = 600  # Fixed profit per job
